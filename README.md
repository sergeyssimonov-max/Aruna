...
[v2.5.9](https://github.com/sergeyssimonov-max/Aruna/releases/tag/v2.5.9) is the third reference, and is the release named at the top of this section: the current one.
...
2026-09-13, replaced by v2.5.7, v2.5.7 later the same day, replaced by v2.5.8, and v2.5.8
on 2026-09-20, replaced by v2.5.9. A reference cannot
...
from below; nothing between v1.0.9 and v2.5.9 does that now. The floor still holds, and the history of what changed when is in the
