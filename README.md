...
[v2.5.8](https://github.com/sergeyssimonov-max/Aruna/releases/tag/v2.5.8) is the third reference, and is being replaced by the release named at the top of this section.
...
2026-09-13, replaced by v2.5.7, and v2.5.7 later the same day, replaced by v2.5.8. A reference cannot
...
from below; nothing between v1.0.9 and v2.5.8 does that now. The floor still holds, and the history of what changed when is in the
