...
**[v2.5.5](https://github.com/sergeyssimonov-max/Aruna/releases/latest) is the
...
[v2.5.4](https://github.com/sergeyssimonov-max/Aruna/releases/tag/v2.5.4) is the third reference, and is being replaced by the release named at the top of this section.
...
v2.5.3, and v2.5.3 on 2026-09-07, replaced by v2.5.4. A reference cannot
...
from below; nothing between v1.0.9 and v2.5.4 does that now. The floor still holds, and the history of what changed when is in the
