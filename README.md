...
window as the thing a reader installs — and v2.5.2 on 2026-09-06, replaced by
v2.5.3. A reference cannot
...
from below; nothing between v1.0.9 and v2.5.3 does that now. The floor still holds, and the history of what changed when is in the
