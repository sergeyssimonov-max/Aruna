...
**[v2.5.8](https://github.com/sergeyssimonov-max/Aruna/releases/latest) is the
...
[v2.5.8](https://github.com/sergeyssimonov-max/Aruna/releases/tag/v2.5.8) is the third: the release named at the top of this section.
