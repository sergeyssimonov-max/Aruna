...
**[v2.5.7](https://github.com/sergeyssimonov-max/Aruna/releases/latest) is the
...
[v2.5.6](https://github.com/sergeyssimonov-max/Aruna/releases/tag/v2.5.6) is the third reference, and is being replaced by the release named at the top of this section.
...
replaced by v2.5.5, v2.5.5 on 2026-09-12, replaced by v2.5.6, and v2.5.6 on
2026-09-13, replaced by v2.5.7. A reference cannot
...
from below; nothing between v1.0.9 and v2.5.7 does that now. The floor still holds, and the history of what changed when is in the
