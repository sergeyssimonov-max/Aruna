...
[`PROJECT-SPEC.ru.md`](PROJECT-SPEC.ru.md) (редакция 41, 2026-09-08), which is normative; this
...
| | |
|---|---|
| `cli/` | package `aruna` 2.5.4 — the program. A library (`aruna`) plus a binary (`aruna`) that is a thin adapter over it. |
