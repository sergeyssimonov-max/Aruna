...
[`PROJECT-SPEC.ru.md`](PROJECT-SPEC.ru.md) (редакция 54, 2026-09-16), which is normative; this
...
| | |
|---|---|
| `cli/` | package `aruna` 2.5.8 — the program. A library (`aruna`) plus a binary (`aruna`) that is a thin adapter over it. |
