...
[`PROJECT-SPEC.ru.md`](PROJECT-SPEC.ru.md) (редакция 49, 2026-09-13), which is normative; this
...
| | |
|---|---|
| `cli/` | package `aruna` 2.5.6 — the program. A library (`aruna`) plus a binary (`aruna`) that is a thin adapter over it. |
