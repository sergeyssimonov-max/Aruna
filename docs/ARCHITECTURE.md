...
[`PROJECT-SPEC.ru.md`](PROJECT-SPEC.ru.md) (редакция 62, 2026-09-18), which is normative; this
...
| | |
|---|---|
| `cli/` | package `aruna` 2.5.10 — the program. A library (`aruna`) plus a binary (`aruna`) that is a thin adapter over it. |
