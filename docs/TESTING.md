...
The suite is **639 tests** as of 2026-09-26: 600 in the console crate – twenty
...
back to the console crate. It needs no network, and it runs **632**: seven are
...
Beside it, and in a language of its own, are the **147 `vitest` tests** in
